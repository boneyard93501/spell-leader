...
#[marine]
pub fn indexer(key: String, vals: Vec<String>) -> IdxResult {
...
mod tests {
    ...
    ///Users/bebo/localdev/eff-0.15.10/src/modules/leader_election/src/main.rs
    #[marine_test(config_path = "../../../../.fluence/tmp/Config.toml")]
    fn test_idx(elector: marine_test_env::leader_election::ModuleInterface) {
        ...
        let idx_res = elector.indexer(ref_key, ids.clone());
